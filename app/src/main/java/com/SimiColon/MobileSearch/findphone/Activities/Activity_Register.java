...
public class Activity_Register extends AppCompatActivity implements View.OnClickListener {
    ...
    private void saveToServerDB() {
        ...
        pDialog.setMessage(getString(R.string.create_account));
        ...
        String uaddress = phone.getText().toString();
        
        Service services = ServiceApi.createClient().create(Service.class);
        Call<Register_Model> userCall = services.userSignUp(uname,upass,enCodedImage,uphone,uemail,ucountry,ucity,uaddress);
